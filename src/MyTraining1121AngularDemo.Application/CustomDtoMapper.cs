...
namespace MyTraining1121AngularDemo
{
    internal static class CustomDtoMapper
    {
        ...
        {
            configuration.CreateMap<CreateOrEditPersonDto, Person1>().ReverseMap();
            configuration.CreateMap<PersonDto1, Person1>().ReverseMap();

            configuration.CreateMap<Persons, PersonListDto>();
            configuration.CreateMap<CreatePersonInput, Persons>();
            configuration.CreateMap<Phone, PhoneInPersonListDto>();
            configuration.CreateMap<AddPhoneInput, Phone>();
            configuration.CreateMap<Persons, GetPersonForEditOutput>();
